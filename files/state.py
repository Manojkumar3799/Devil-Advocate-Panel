"""State schema for the Devil's Advocate Panel LangGraph graph."""
...
class TranscriptEntry(TypedDict):
    ...
    round: int
    thinking: str
    question: str  # or, for the user, empty
    user_reply: str | None
    provider_used: str
...
def initial_state(pitch_text: str, intensity: Intensity, connected_providers: list[str]) -> PanelState:
    return PanelState(
